...
const (
	// Label holds the string label denoting the sweepresult type in the database.
	Label = "sweep_result"
	...
	// FieldCheckInImage holds the string denoting the check_in_image field in the database.
	FieldCheckInImage = "check_in_image"
	...
	// Table holds the table name of the sweepresult in the database.
	Table = "sweep_results"
	// CreatorTable is the table that holds the creator relation/edge.
	CreatorTable = "sweep_results"
	...
	SweepScheduleTable = "sweep_results"
	...
	SweepResultDetailsColumn = "sweep_result_id"
)

// Columns holds all SQL columns for sweepresult fields.
var Columns = []string{
	FieldID,
	FieldCreateTime,
	FieldCreatorID,
...
// OrderOption defines the ordering options for the SweepResult queries.
