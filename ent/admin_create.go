...
func (ac *AdminCreate) SetNillableCreatedBy(i *int) *AdminCreate {
	if i != nil {
		ac.SetCreatedBy(*i)
	}
	return ac
...
func (ac *AdminCreate) AddRiskReportingAdminIDs(ids ...int) *AdminCreate {
	ac.mutation.AddRiskReportingAdminIDs(ids...)
	return ac
}

// AddRiskReportingAdmin adds the "RiskReportingAdmin" edges to the RiskReporting entity.
func (ac *AdminCreate) AddRiskReportingAdmin(r ...*RiskReporting) *AdminCreate {
	ids := make([]int, len(r))
	for i := range r {
		ids[i] = r[i].ID
	}
	return ac.AddRiskReportingAdminIDs(ids...)
}
...
func (ac *AdminCreate) createSpec() (*Admin, *sqlgraph.CreateSpec) {
	...
	if nodes := ac.mutation.RiskReportingAdminIDs(); len(nodes) > 0 {
